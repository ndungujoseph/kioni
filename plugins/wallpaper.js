...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'wallpaper', fromMe: true, desc: Lang.WP}, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(respoimage.data, "base64"), MessageType.image, {mimetype: Mimetype.png, caption: 'Made by Kioni Ndungu. Powered by I.T H.A.C.K.S.'})
    }));
}
    ...
    Asena.addCommand({pattern: 'wallpaper', fromMe: false, desc: Lang.WP}, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: 'Made by Kioni Ndungu. Powered by I.T H.A.C.K.S.'})
